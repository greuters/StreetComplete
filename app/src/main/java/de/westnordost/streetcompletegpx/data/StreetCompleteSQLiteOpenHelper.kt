...
import de.westnordost.streetcompletegpx.data.download.tiles.DownloadedTilesTable
import de.westnordost.streetcompletegpx.data.osm.created_elements.CreatedElementsTable
import de.westnordost.streetcompletegpx.data.osm.edits.EditElementsTable
import de.westnordost.streetcompletegpx.data.osm.edits.ElementEditsTable
import de.westnordost.streetcompletegpx.data.osm.edits.ElementIdProviderTable
import de.westnordost.streetcompletegpx.data.osm.edits.upload.changesets.OpenChangesetsTable
import de.westnordost.streetcompletegpx.data.osm.geometry.RelationGeometryTable
import de.westnordost.streetcompletegpx.data.osm.geometry.WayGeometryTable
import de.westnordost.streetcompletegpx.data.osm.mapdata.NodeTable
import de.westnordost.streetcompletegpx.data.osm.mapdata.RelationTables
import de.westnordost.streetcompletegpx.data.osm.mapdata.WayTables
import de.westnordost.streetcompletegpx.data.osm.osmquests.OsmQuestTable
import de.westnordost.streetcompletegpx.data.osm.osmquests.OsmQuestsHiddenTable
import de.westnordost.streetcompletegpx.data.osmnotes.NoteTable
import de.westnordost.streetcompletegpx.data.osmnotes.edits.NoteEditsTable
import de.westnordost.streetcompletegpx.data.osmnotes.notequests.NoteQuestsHiddenTable
import de.westnordost.streetcompletegpx.data.user.achievements.UserAchievementsTable
import de.westnordost.streetcompletegpx.data.user.achievements.UserLinksTable
import de.westnordost.streetcompletegpx.data.user.statistics.ActiveDaysTable
import de.westnordost.streetcompletegpx.data.user.statistics.CountryStatisticsTables
import de.westnordost.streetcompletegpx.data.user.statistics.EditTypeStatisticsTables
import de.westnordost.streetcompletegpx.data.visiblequests.QuestPresetsTable
import de.westnordost.streetcompletegpx.data.visiblequests.QuestTypeOrderTable
import de.westnordost.streetcompletegpx.data.visiblequests.VisibleQuestTypeTable
import de.westnordost.streetcompletegpx.quests.oneway_suspects.data.WayTrafficFlowTable
