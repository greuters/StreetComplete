...
import de.westnordost.streetcompletegpx.data.osm.edits.ElementEditsTable.Columns.ACTION
import de.westnordost.streetcompletegpx.data.osm.edits.ElementEditsTable.Columns.CREATED_TIMESTAMP
import de.westnordost.streetcompletegpx.data.osm.edits.ElementEditsTable.Columns.GEOMETRY
import de.westnordost.streetcompletegpx.data.osm.edits.ElementEditsTable.Columns.ID
import de.westnordost.streetcompletegpx.data.osm.edits.ElementEditsTable.Columns.IS_SYNCED
import de.westnordost.streetcompletegpx.data.osm.edits.ElementEditsTable.Columns.LATITUDE
import de.westnordost.streetcompletegpx.data.osm.edits.ElementEditsTable.Columns.LONGITUDE
import de.westnordost.streetcompletegpx.data.osm.edits.ElementEditsTable.Columns.QUEST_TYPE
import de.westnordost.streetcompletegpx.data.osm.edits.ElementEditsTable.Columns.SOURCE
import de.westnordost.streetcompletegpx.data.osm.edits.ElementEditsTable.NAME
...
import de.westnordost.streetcompletegpx.data.osm.edits.create.RevertCreateNodeAction
import de.westnordost.streetcompletegpx.data.osm.edits.delete.DeletePoiNodeAction
import de.westnordost.streetcompletegpx.data.osm.edits.delete.RevertDeletePoiNodeAction
import de.westnordost.streetcompletegpx.data.osm.edits.move.MoveNodeAction
import de.westnordost.streetcompletegpx.data.osm.edits.move.RevertMoveNodeAction
