...
Are you trying to implement a quest that will have simple yes/no answer? Take [`AddIsDefibrillatorIndoor`](app/src/main/java/de/westnordost/streetcompletegpx/quests/defibrillator/AddIsDefibrillatorIndoor.kt) quest as a base. Or [`AddTracktype`](app/src/main/java/de/westnordost/streetcompletegpx/quests/tracktype/AddTracktype.kt) where the mapper will be selecting one of presented images.

Is it going to be asked for POIs and should be disabled by default? [`AddWheelchairAccessBusiness`](app/src/main/java/de/westnordost/streetcompletegpx/quests/wheelchair_access/AddWheelchairAccessBusiness.kt) may be a good base.

Quests are grouped in [one folder](app/src/main/java/de/westnordost/streetcompletegpx/quests).
...
Search for this identifier in `*.kt` files, it should appear in the quest file (in this case [AddPlaceName.kt](app/src/main/java/de/westnordost/streetcompletegpx/quests/place_name/AddPlaceName.kt)).
...
Adjust [QuestsModule.kt](app/src/main/java/de/westnordost/streetcompletegpx/quests/QuestsModule.kt) file. It contains a big list of active quests, ordered by priority. Read [what governs their priority](app/src/main/java/de/westnordost/streetcompletegpx/quests/QuestsModule.kt#L172-L195) but do not worry too much, it can be tweaked later.
...
See for example [simple yes/no quest asking whether AED is indoor or outdoor](app/src/main/java/de/westnordost/streetcompletegpx/quests/defibrillator/AddIsDefibrillatorIndoor.kt).
...
See the documentation of [`ElementFilterExpression`](app/src/main/java/de/westnordost/streetcompletegpx/data/elementfilter/ElementFilterExpression.kt) for a complete documentation of the syntax. You can look around some quests to see more examples of such element filter expressions.
...
In quest achievements, list what is relevant to the given quest, see the full list of available ones in [AchievementsModule.kt](app/src/main/java/de/westnordost/streetcompletegpx/data/user/achievements/AchievementsModule.kt)
...
But sometimes more complex ones are needed, see for example [AddBridgeStructure.kt](app/src/main/java/de/westnordost/streetcompletegpx/quests/bridge_structure/AddBridgeStructure.kt)

`override fun createForm() = AddBridgeStructureForm()`

With form defined in [AddBridgeStructureForm](app/src/main/java/de/westnordost/streetcompletegpx/quests/bridge_structure/AddBridgeStructureForm.kt)
...
which causes nearby `emergency = defibrillator` nodes to be shown (icons used are defined in [PinIcons.kt](app/src/main/java/de/westnordost/streetcompletegpx/screens/main/map/PinIcons.kt))

See [also other optional properties](app/src/main/java/de/westnordost/streetcompletegpx/data/osm/osmquests/OsmElementQuestType.kt).
...
- Allow to answer popular edge cases, but don't clutter up the main form with that. A good pattern is to move such answers into the "Other answers..." menu. E.g. look at the [opening hours quest](app/src/main/java/de/westnordost/streetcompletegpx/quests/opening_hours/AddOpeningHoursForm.kt#L40-L48).
...
Typical code is in [quest asking about motorcycle parking capacity](app/src/main/java/de/westnordost/streetcompletegpx/quests/motorcycle_parking_capacity/AddMotorcycleParkingCapacity.kt):
...
But using regexp like `surface ~ ^(.*)[0-9]$` is [also possible](app/src/test/java/de/westnordost/streetcompletegpx/data/elementfilter/filters/ElementFilterOverpassKtTest.kt#L79-L88).

It is possible to check for [age of elements](app/src/main/java/de/westnordost/streetcompletegpx/quests/construction/MarkCompletedHighwayConstruction.kt#L13-L17) or implement a [fully custom tag parsing](app/src/main/java/de/westnordost/streetcompletegpx/quests/opening_hours/AddOpeningHours.kt#L137-L151), still combined with filter syntax.

It is possible to share and reuse [information about tagging schemes](app/src/main/java/de/westnordost/streetcompletegpx/quests/surface/AddRoadSurface.kt#L18).

(this info is gathered [here](/app/src/main/java/de/streetcomplete/StreetComplete/data/meta/OsmTaggings.kt))

Even more complex ones using different class bases are possible. Such as what was needed by the [address quest](app/src/main/java/de/westnordost/streetcompletegpx/quests/address/AddAddressStreet.kt) or the [crossing quest](app/src/main/java/de/westnordost/streetcompletegpx/quests/crossing/AddCrossing.kt) but it is better to start from something simpler.
